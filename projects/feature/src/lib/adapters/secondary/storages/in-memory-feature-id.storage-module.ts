...
@NgModule({ imports: [],
  	declarations: [],
  	providers: [InMemoryFeatureIdStorage, { provide: SETS_STATE_FEATURE_CONTEXT, useExisting: InMemoryFeatureIdStorage }, { provide: SETS_STATE_FEATURE_ID_CONTEXT, useExisting: InMemoryFeatureIdStorage }, { provide: SELECTS_FEATURE_ID_CONTEXT, useExisting: InMemoryFeatureIdStorage }],
  	exports: [] })
