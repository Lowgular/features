...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseFeaturesService, { provide: ADDS_FEATURE_DTO, useExisting: FirebaseFeaturesService }, { provide: GETS_ALL_FEATURE_DTO, useExisting: FirebaseFeaturesService }],
  	exports: [] })
